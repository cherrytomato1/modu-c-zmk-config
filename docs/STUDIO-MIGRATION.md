...
## Fn 레이어의 Vim 방향키와 왼쪽 기호열

레이어2 H/J/K/L는 ←/↓/↑/→, Q/W/E/R/T는 -/=/[/]/작은따옴표입니다. Mac 기본 전환은 Fn+F, Windows 기본 전환은 Fn+G입니다. 원래 Fn+Q의 Home은 Fn+S로, H/J/K/L의 마우스 버튼은 기호가 빠진 U/I/O/P 위치로 같은 순서(오른쪽/왼쪽/가운데/오른쪽 클릭)로 이동했습니다. 기존 Fn+Y 가운데클릭과 Fn+N 왼쪽클릭도 유지됩니다. 예전 Fn+E/S/D/F 방향키와 Fn+U/I/O/P/세미콜론 기호 위치는 새 배열로 대체됩니다.
